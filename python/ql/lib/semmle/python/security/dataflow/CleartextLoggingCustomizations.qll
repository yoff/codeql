...
module CleartextLogging {
  ...
  private predicate isCallOn(DataFlow::CallCfgNode call, string receiverName, string methodName) {
  ...
  private class AirflowNonSensitiveConfigValue extends Sanitizer, DataFlow::CallCfgNode {
    AirflowNonSensitiveConfigValue() {
      (
        inMethod(this, "airflow.executors.executor_loader", "ExecutorLoader", "_get_executor_names") and
        isCallOn(this, "conf", "get_mandatory_list_value") and
        this.getArg(1).asExpr().(StringLiteral).getText().toLowerCase() = "executor"
        or
        inMethod(this, "airflow.api_internal.internal_api_call", "InternalApiConfig", "_init_values") and
